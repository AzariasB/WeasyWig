            ...
            <div id="parts">
                <div class="row white" id="Projects" >
                    <div class="col-xs-12">
                        ...
                        <?php if (count($projects) > 0): ?>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="list-group list-unstyled">
                                    <a class="btn btn-default btn-block" id="new_project" href="editor.html">Create new project</a>
                                    <?php
                        ...
                        ?>
                        <p class="lead" >
                            Once you are in the editor, you can get some help in the part called 'help'.
                ...
                <div class="row fill transparent no-lightbox" id="Localisation" >
                    ...
                    <div class='col-sm-6 col-xs-12 fill text-center' id="map_container" >
                        ...
                        <div id="map_panel" class="col-xs-12" >
                            <h3>Right click on the map to set the origin point</h3>
                ...
                <div class="row fill white" id="API">
                    ...
                    <div class="hidden-xs col-sm-6">
                        <object hidden="" data="assets/svg/cog.svg"></object>
                    </div>
                </div>
                <div class="row fill transparent" id="Dependencies" >
                    ...
                    <div class="col-xs-6 text-center gallery">
                        <div class="col-xs-12">
                            ...
                            <object width="23%" hidden="" type="image/svg+xml" data="assets/svg/bootstrap.svg"></object>
                            <object width="23%" hidden="" type="image/svg+xml" data="assets/svg/jQuery.svg"></object>
                            <object width="23%" hidden="" type="image/svg+xml" data="assets/svg/jquery_ui.svg"></object>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <p class="lead" >
                ...
                <div class="row fill white" id="Contact">
                    ...
                    <div class="col-xs-12 col-sm-6 lead">
                        ...
                        <p><b><a href="mailto:support@weasywig.com">support@weasywig.com</a></b></p>
                ...
                <div class="col-xs-12 col-sm-4">
                    <ul class="list-unstyled" > 
                        ...
                        <li>
                            ...
                            <b><a href="mailto:support@weasywig.com">support@weasywig.com</a></b>
                        </li>
                    </ul>
                </div>
                <div class="col-xs-12 col-sm-4">
