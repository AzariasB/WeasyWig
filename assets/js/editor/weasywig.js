...
// instead of `window` for `WebWorker` support.
    ...
    Weasywig.ajaxGetSave = function (projectName, $root, callback) {
        $root.load('assets/saves/' + projectName + '.html', function () {
            callback && callback.call(Weasywig.view);
    ...
    Weasywig.lastQuestion = function (domNTemplate) {
        var self = this;
        if (!domNTemplate) {
            this.ajaxRendering(null, null, null);
        } else {
